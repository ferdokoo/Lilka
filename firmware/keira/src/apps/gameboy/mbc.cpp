...
unsigned int gb_MBC3_write_byte(unsigned short d, unsigned char i)
{
	int bank;
...
unsigned int gb_MBC1_write_byte(unsigned short d, unsigned char i)
{
	int bank;
