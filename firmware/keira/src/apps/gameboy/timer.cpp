...
void gb_timer_set_div(unsigned char v)
{
	(void) v;
	divider = 0;
}
...
void gb_timer_set_counter(unsigned char v)
{
	counter = v;
}
...
void gb_timer_set_modulo(unsigned char v)
{
	modulo = v;
}
...
void gb_timer_set_tac(unsigned char v)
{
...
void gb_timer_cycle(void)
{
	...
	unsigned int delta = gb_cpu_get_cycles() - prev_time;
	prev_time = gb_cpu_get_cycles();
